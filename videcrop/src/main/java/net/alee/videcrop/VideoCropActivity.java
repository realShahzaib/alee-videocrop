...
import net.alee.videcrop.ffmpeg.ExecuteBinaryResponseHandler;
import net.alee.videcrop.ffmpeg.FFmpeg;
import net.alee.videcrop.ffmpeg.FFtask;
...
public class VideoCropActivity extends AppCompatActivity implements VideoPlayer.OnProgressUpdateListener, VideoSliceSeekBarH.SeekBarChangeListener {
    ...
    private static final String TAG = "MYTAGCROP";
    ...
    public static Intent createIntent(Context context, String inputPath1, String outputPath1) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String folder_main = "/SuperFXVideos";
        outputPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES) + folder_main + new StringBuilder("/folder_main").append(new SimpleDateFormat("dd-MM-yyyy-hh_mm_ss").format(new Date())).append(".mp4").toString();
        Toast.makeText(VideoCropActivity.this, "in : " + inputPath + " out : " + outputPath, Toast.LENGTH_SHORT).show();
        Log.d("paths", outputPath + "--" + inputPath);
